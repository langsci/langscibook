\documentclass[biblatex,output=short]{LSP/langsci}
...
% The following is langsci.cls specific. lsp-gb4e.sty should not make reference to this without providing the command \il
