...
\frame{ 
\frametitle{\parbox{5cm}{Der Mehrwert eines\\  wissenschaftlichen Verlags}} 
\begin{itemize}
...
\begin{itemize}
 ...
 \item (ohne Chomskys "`Syntactic Structures"' gäbe es heute Mouton De Gruyter nicht)
 \end{itemize}
...
\begin{itemize}
 \item Author-pays-Modell: Der Autor trägt die "`Druckkosten"' komplett\\
       (ca.\ 15.000€ bei SpringerOpen, ca.\ 10.000€ bei De Gruyter Open)
 \item Freemium-Modell: Die Bücher sind im Prinzip frei verfügbar,\\
       aber für spezielle Services (z.\,B.\ EPUB-Version) muss man zahlen\nocite{Mounier2011a}
 \item Publisher-pays-Modell
\begin{itemize}
\item  Der Verlag trägt die Publikationskosten, mit dem Ziel,\\
       durch gute Bücher sein Renommee zu steigern 
