...
% \fuberlinlogon{0.78cm}

% \usepackage{eurosym} % UG
% \usepackage{ogonek}
...
\item 10.2012 Kick-Off-Treffen an der FU-Berlin mit internationaler Beteiligung (Skype, Anke
...
\begin{itemize}
\item    Artemis Alexiadou (Universität Stuttgart)
\item    Jim Blevins (University of Cambridge)
\item    Balthasar Bickel (Universität Zürich)
\item    Geert Booij (Leiden University)
\item    Miriam Butt (University of Konstanz)
\item    Ewa Dąbrowska (Northumbria University, Newcastle)
\item    Arnulf Deppermann (Institut für Deutsche Sprache, Mannheim)
\item    Nomi Erteschik-​Shir (Ben Gurion University of the Negev)
\item    Martine Grice (University of Cologne)
\item    Mutsumi Imai (Keio University at Shonan-Fujisawa)
\item    Laura Kallmeyer (University of Düsseldorf)
\item    Manfred Krifka (Humboldt Universität zu Berlin and ZAS)
\item    Mary Esther Kropp Dakubu (University of Ghana)
\item    Aditi Lahiri (University of Oxford)
\item    Stephen Levinson (Max Planck Institute for Psycholinguistics in Nijmegen)
\item    Anke Lüdeling (Humboldt-​Universität zu Berlin)
\item    Detmar Meurers (Eberhard-​Karls-Universität Tübingen)
\item    Sam Mchombo (University of California, Berkeley)
\item    Rachel Nordlinger (University of Melbourne)
\item    Jairo Nunes (University São Paulo)
\item    Steven Pinker (Harvard University)
\item    Friedemann Pulvermüller (Freie Universität Berlin)
\item    Stuart Shieber (Harvard University)
\item    Dieter Stein (Universität Düsseldorf) 
% 24
\end{itemize}
...
\begin{itemize}
\item Projektorganisation/Press Manager: Stefan Müller und Martin Haspelmath
\item Projektkoordination: Sebastian Nordhoff (seit 25.02.2014)
\item Design: Dipl.-Des. Ulrike Harbort (Buch-Layout, Web-Konzept, Poster)
...
\item Proofreader: Eitan Grossman, Daniel W. Hieber, Aron Sonnenschein
\end{itemize}
...
\item 1/2 Stelle: Support/Betreuung von Herausgebern/Autoren an der CEDIS
\item 1/2 Stelle: BWLer: Dokumentation der Kosten, Geschäftsmodell\\
      (optinales Author Pays, optionale Bibliotheksbeiträge, Micropayment-Spenden, \ldots)
\end{itemize}
...
\frame{
\frametitle{Preisliste}

\begin{itemize}
\item De Gruyter Open: 10.000€ pro Buch\\
      (1.500€ bei normalen Büchern, wenn nicht selbst gesetzt)
\item Brill: 5.000€ pro Buch
\item Language Science Press: 0€ pro Buch\\
