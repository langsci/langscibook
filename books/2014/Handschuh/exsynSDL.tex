...
His other form of extra-syntactic use is the function of `quotation and designation' (ibid. 450), which corresponds to my \textit{citation form}.\is{citation form|)}   


%\section{Morphological Criteria}

%\subsection{Base of Case-Forms}

%\subsection{Base for Compounding}
...
\begin{exe} 
%\ex\begin{xlist}
\ex\label{DinGenEx} {Dinka\il{Dinka (Agar)}} \citep[Nilotic; Sudan; ][273]{Andersen:1991}\nopagebreak[4]
...
\begin{exe}\ex\label{BorGenEx} {Oromo (Boraana\il{Oromo (Boraana)})} \citep[Eastern Cushitic; Ethiopia; ][35]{Stroomer:1995}\nopagebreak[4]
\gll mina ciif\textbf{-aa}\\
house chief-\gen{}\\
`the house of the chief.'
\end{exe} 

\begin{exe}\ex\label{CocGenEx} {Cocopa\il{Cocopa}} \citep[Yuman; California; ][165]{Crawford:1966}\nopagebreak[4]
...
\begin{exe}\ex\label{ArbAntiGen} {Arbore\il{Arbore}} \citep[Eastern Cushitic; Ethiopia; ][151]{Hayward:1984}\nopagebreak[4]
...
\begin{exe} 
\ex\label{TenGenEx} {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][230]{Randal:1998}\nopagebreak[4]
...
\begin{exe}\ex\label{GamVocEx} {Gamo\il{Gamo}} \citep[Omotic; Ethiopia; ][282, 283]{Hompo:1990}\nopagebreak[4]
\gll danna\textbf{-wu}!\\
judge-\voc{}\\
`Oh, judge!'
\end{exe}

\begin{exe}\ex\label{NiaVocEx} {Nias\il{Nias}}  \citep[Sundic; Indonesia; ][59]{Brown:2001}\nopagebreak[4] 
...
\begin{exe}\ex\label{DatGen} {Datooga\il{Datooga}} \citep[Nilotic; Tanzania; ][178, 179]{Kiessling:2007}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MaaGen} {Maa\il{Maa}} \citepalias[Nilotic; Kenya; ][213]{Tucker:1955}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{NanGen} {Nandi\il{Nandi}} \citep[Nilotic; Kenya; ][69]{Creider:1989}\nopagebreak[4]
...
\begin{exe}
\ex\label{MurGen} {Murle\il{Murle}}  \citep[Surmic; Sudan; ][108]{Arensen:1982}\nopagebreak[4]
...
\begin{exe}
\ex\label{TenGen} {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][230]{Randal:1998}\nopagebreak[4]
\gll\textipa{mana} \textipa{c\'I} \textipa{ongol\textbf{-\=*o}} \\
field \am{} elephant-\gen{}\\
`Elephant's field.'  
\end{exe}
...
\begin{exe}\ex\label{TurGen} {Turkana\il{Turkana}} \citep[Nilotic; Kenya; ][267, 384, 167]{Dimmendaal:1982}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}
\ex\label{DinGen} {Dinka\il{Dinka (Agar)}} \citep[Nilotic; Sudan; ][273]{Andersen:1991}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}
\ex\label{DatVoc} {Datooga\il{Datooga}}  \citep[171]{Kiessling:2007}\nopagebreak[4]
...
\begin{exe}\ex\label{TurVoc} {Turkana\il{Turkana}} \citep[268, 269]{Dimmendaal:1982}\nopagebreak[4]
\begin{xlist}
\ex\textipa{N\`I-dE\`{}} `children!'

\ex\textipa{\`E-k\`a-tuk-\`o-n\r*i}	`chief!'
\end{xlist}
\end{exe}

%{Turkana\il{Turkana}} \citep[75]{Dimmendaal:1982}
\begin{exe}
\ex\label{TurNonVoc} {Turkana\il{Turkana}} \citep[75]{Dimmendaal:1982}\nopagebreak[4]
\gll\textipa{NI-dE\'{}} \textipa{omwOn\'{}}\\
\NC{}-children.\acc{} four\\
`There are four children.' %check reference
...
\begin{exe}\ex\label{HarGen} {Oromo (Harar\il{Oromo (Harar)})}  \citep[Eastern Cushitic; Ethiopia; ][103]{Owens:1985}\nopagebreak[4]
...
\begin{exe}\ex\label{BorGen} {Oromo (Boraana\il{Oromo (Boraana)})} \citetext{Eastern Cushitic; Ethiopia; \citealt[35]{Stroomer:1995} \citealt[50]{Owens:1982}}\nopagebreak[4] % check output
\begin{xlist}
...
`As for the man, his house is good.' %\citep[50]{Owens:1982}
\end{xlist}
\end{exe} 
...
\pagebreak
\begin{exe}\ex\label{GamGen} {Gamo\il{Gamo}} \citep[Omotic; Ethiopia; ][368, 375]{Hompo:1990}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{KabGen} {K'abeena\il{K'abeena}} \citep[Eastern Cushitic; Ethiopia; ][115]{Crass:2005}\nopagebreak 
\begin{xlist} 
...
\begin{exe}\ex\label{WolGen} {Wolaytta\il{Wolaytta}} \citep[Omotic; Ethiopia; ][217, 218]{Lamberti:1997}\nopagebreak[4]
\begin{xlist}
...
\begin{exe} \ex\label{ZayGen} {Zayse\il{Zayse}} \citep[Omotic; Ethiopia; ][251]{Hayward:1990}\nopagebreak
...
%\pagebreak
\begin{exe}\ex\label{ArbGen} {Arbore\il{Arbore}} \citep[Eastern Cushitic; Ethiopia; ][151]{Hayward:1984}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{GamVoc} {Gamo\il{Gamo}} \citep[282, 283]{Hompo:1990}\nopagebreak[4]
\begin{xlist}
\ex\gll danna-wu!\\
judge-\voc{}\\
`Oh, judge!'
...
\begin{exe}\ex\label{WolVoc} {Wolaytta\il{Wolaytta}} \citep[209]{Lamberti:1997}\nopagebreak[4]
...
\pagebreak
\begin{exe}\ex\label{AijGen} {Aji\"e\il{Aji\"e}} \citep[Oceanic; New Caledonia; ][85, 86]{Lichtenberk:1978}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{pwe} \textbf{\textipa{bwE\textglotstop}}\\
belly woman\\
`the womans's belly.' % \citet[85]{Lichtenberk:1978}\end{exe}

\ex\gll\textipa{karrO} \textbf{\textipa{kamO\textglotstop}}\\
body man\\
`the man's body' %\citet[85]{Lichtenberk:1978} after \citet[17]{Leenhardt:1935}\end{exe}

\ex\gll\textipa{nev\~a} \textbf{\textipa{i}} \textipa{wi\textglotstop}\\
land \gen{} man\\
`the man's land.' %\citet[86]{Lichtenberk:1978}\end{exe} 
\end{xlist}
\end{exe}
...
\begin{exe}
\ex\label{NiaGen} {Nias\il{Nias}} \citep[Sundic; Indonesia; ][374]{Brown:2001}\nopagebreak[4]
\gll telau mbuaya\\
head crocodile.\mut{}\\
...
\begin{exe}\ex\label{SavGen} {Savosavo\il{Savosavo}} \citep[Solomons East Papuan; Solomon Islands; ][132]{Wegener:2008}\nopagebreak[4]
...
\pagebreak
\begin{exe}\ex\label{AijVoc} {Aji\"e\il{Aji\"e}} \citep[199]{Fontinelle:1961}\nopagebreak[4]
...
\begin{exe}
\ex\label{NiaVoc} {Nias\il{Nias}}  \citep[59]{Brown:2001} 
\gll Haiya ni-wa\"o-u ga,  \textbf{am\'a}?\\
what \pass{}-say-2\sg{}.\poss{} here father\\
`What is it you want here, Sir?'
\end{exe}

\begin{exe}\ex\label{SavVoc} {Savosavo\il{Savosavo}} \citep[127]{Wegener:2008}\nopagebreak[4]
...
\begin{exe}\ex\label{MojGen} {Mojave\il{Mojave}} \citep[50, 18]{Munro:1976}\nopagebreak[4]
...
`The doctor's house' %\citep[18]{Munro:1976}
\end{xlist}
\end{exe}
...
\begin{exe}\ex\label{CocGen} {Cocopa\il{Cocopa}} \citep[165]{Crawford:1966}\nopagebreak[4]
\gll \textbf{ap\'a} n\textsuperscript{y}aw\'a\\
man.\acc{} house.\acc{}\\
`The man's house.'
\end{exe}
...
\begin{exe}\ex\label{DieGen} {Diegue\~no\il{Diegue\~no (Mesa Grande)} (Mesa Grande)} \citep[17]{Gorbet:1976}\nopagebreak[4]
...
\begin{exe}\ex\label{JamGen} {Jamul\il{Jamul Tiipay} Tiipay} \citep[152]{Miller:2001}\nopagebreak[4]
...
\begin{exe}\ex\label{MarGen} {Maricopa\il{Maricopa}}  \citep[31, 40]{Gordon:1986}\nopagebreak[4]
\begin{xlist} 
...
\begin{exe}\ex\label{HavGen} {Havasupai\il{Havasupai}} \citep[57]{Kozlowski:1972}\nopagebreak[4]
\begin{xlist} 
\ex \gll \textbf{jan} lwa\\
John.\acc{} wife\\
`John's wife.' %\citet[57]{Kozlowski:1972}\end{exe}

\ex\gll \textbf{pa} \~nu-hu\\
man.\acc{} \dem{}-head\\
`The man's/his head.' %\citet[57]{Kozlowski:1972}\end{exe}
\end{xlist}
\end{exe}

\begin{exe}\ex\label{WalGen} {Walapai\il{Walapai}} \citep[76]{Watahomigie:2001}\nopagebreak[4]
\gll \textbf{Joe} b\'ud-a-ch ya:d-i-k-yu\\
Joe.\acc{} 3.hat-\defsc{}-\nom{} 3.fly-suddenly-\ssbj{}-\aux{}\\
`Joe's hat flew away.'
\end{exe}

\begin{exe}\ex\label{YavGen} {Yavapai\il{Yavapai}} \citep[60]{Kendall:1976}\nopagebreak[4]
...
\begin{exe}\ex\label{WapGen} {Wappo\il{Wappo}} \citep[14, 15]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist}
...
`I made the woman eat the man's meat' %\citet[14]{Thompsonetal:2006}

\ex\gll\textbf{\textipa{c'ic'a}} \textipa{khap-i} \textipa{ke\textglotstop te-khi\textglotstop}\\
bird.\acc{} wing-\nom{} broken-\stat{}\\
`the bird's wing is broken'% \citet[15]{Thompsonetal:2006}
\end{xlist}
\end{exe}
...
\begin{exe}\ex \label{MaiGen} {Maidu\il{Maidu}} \citep[31]{Shipley:1964}\nopagebreak[4]
...
%\pagebreak
\begin{exe}\ex\label{CocVoc} {Cocopa\il{Cocopa}} \citep[179]{Crawford:1966}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{DieVoc} {Diegue\~no\il{Diegue\~no (Mesa Grande)} (Mesa Grande)} \citep[158]{Langdon:1970}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{JamVoc} {Jamul\il{Jamul Tiipay} Tiipay} \citep[128]{Miller:1990}\nopagebreak[4]
...
\begin{exe}\ex\label{WalVoc} {Walapai\il{Walapai}} \citep[56]{Watahomigie:2001}\nopagebreak[4]
%\begin{xlist}
...
`My daughters! Eat!' %\citet[56]{Watahomigie:2001}
%\end{xlist}
\end{exe}
