...
\footnote{The following English\il{English} examples are adverbial clauses having a different (\ref{EngAdvCl}a) and co-referential subject (\ref{EngAdvCl}b).
...
\textsc{Complement clauses}\is{clause-type!complement clause|(} serve as arguments of the main clause -- or the matrix clause, as the non-complement clause in this construction is usually referred to. 
...
\begin{exe}\ex\label{TenPassive} {Tennet\il{Tennet}} \citep[Surmic; Sudan;  ][245]{Randal:1998}\nopagebreak[4]
...
\begin{exe}\ex\label{TenAntiPassive}  {Tennet\il{Tennet}} \citep[245]{Randal:1998}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{WapDepEx} \begin{sloppypar}{Wappo\il{Wappo}} \citetext{Wappo\il{Wappo}-Yukian; California; \citealt[4, 117, 77]{Thompsonetal:2006}, \citealt[239]{Adverbial}}\end{sloppypar}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MurDepEx} {Murle\il{Murle}} \citep[Surmic; Sudan; ][112, 113]{Arensen:1982}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MojDepEx} {Mojave\il{Mojave}} \citetext{Yuman; Arizona; \citealt[188]{Munro:1976}, \citealt[144]{Munro.com:1980}}\nopagebreak[4]
\begin{xlist}
...
`After I peeled the potatoes, Judy fried them.' %[144]{Munro.com:1980}\end{xlist}
\end{xlist}
\end{exe}
...
\pagebreak
\begin{exe} \ex\label{HarDepEx}  {Oromo (Harar\il{Oromo (Harar)})} \citep[Eastern Cushitic; Ethiopia; ][131, 143]{Owens:1985}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{TenVDO} {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][245]{Randal:1998}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{\'{\=*a}-r\'{\=*u}h-w-\=*e} \textipa{\=*id\=*ong} \textipa{\'{\=*I}y\'{\=*o}k\=*o}\\
\ipfv{}-beat-\epen{}-\pass{} drum.\nom{} now\\
`The drum is being beaten now.' 
...
\enlargethispage{\baselineskip}
\begin{exe}\ex\label{MaaVDO} {Maa\il{Maa}} \citep[Nilotic; Kenya; ][]{Payne:2007}\nopagebreak[4] 
\begin{xlist}
...
\begin{exe} \ex\label{WapRelS} {Wappo\il{Wappo}} \citep[Wappo\il{Wappo}-Yukian; California; ][117, 41]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist} 
...
`The man who laughed is looking at the deer.' %[117]
...
\begin{exe}\ex\label{WapDat} {Wappo\il{Wappo}} \citep[117, 12]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist} 
...
\begin{exe}\ex\label{WapTempCl} {Wappo\il{Wappo}} \citetext{\citealt[71, 77]{Thompsonetal:2006}, \citealt[239]{Adverbial}}\nopagebreak[4]
\begin{xlist}
%\ex\gll [\textipa{\textbf{mi}} \textipa{mi-noma} \textipa{mu-le\textglotstop a-cel'}] \textipa{u\v ci} \textipa{ola} \textipa{mi\textglotstop} \textipa{hintolik-si\textglotstop}\\
...
`When the white man comes, don't talk' %[71]{Thompsonetal:2006}
...
`If you had fed it, it wouldn't have died' %\citet[77]{Thompsonetal:2006}
...
\begin{exe}\ex\label{MojRelS} {Mojave\il{Mojave}} \citep[Yuman; Arizona; ][188]{Munro:1976}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MojRelA} {Mojave\il{Mojave}} \citep[188]{Munro:1976}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MojRelSubj} {Mojave\il{Mojave}} \citetext{\citealt[188]{Munro:1976}}\nopagebreak[4]
\begin{xlist}
...
\enlargethispage{\baselineskip}
\begin{exe}\ex\label{MojRelSub} {Mojave\il{Mojave}} \citetext{\citealt[451]{Munro:1977}, \citealt[221]{Munro:1976}}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MojTemp} {Mojave\il{Mojave}} \citetext{\citealt[12]{Munro.com:1980}, \citealt[322]{Langdon.Munro:1979}}\nopagebreak[4]
\begin{xlist}
...
`When the men came back, my mother cracked acorns.' %\citep[322]{Langdon.Munro:1979}
\end{xlist}
...
But this might be explained by the general possibility of Nominative case-marking to be dropped\is{case-marking!optional} in Mojave\il{Mojave}, especially in fast speech.

\begin{exe}\ex\label{MojComp} {Mojave\il{Mojave}} \citep[274, 220]{Munro:1976}
\begin{xlist}
...
\begin{exe}\ex\label{JamDep} {Jamul\il{Jamul Tiipay} Tiipay} \citep[Yuman; California; ][207, 210, 259]{Miller:2001}\nopagebreak[4]
\begin{xlist}
...
`I bought this horse for you to ride.' %\textbf{Jamul\il{Jamul Tiipay} Tiipai} \citep[259]{Miller:2001}

\end{xlist}
\end{exe}

\enlargethispage{2\baselineskip}
\begin{exe}\ex\label{YavDep} {Yavapai\il{Yavapai}}  \citep[Yuman; Arizona; ][51, 213, 24, 221]{Kendall:1976}\nopagebreak[4] 
\begin{xlist}
...
`The cat that scratched the girl bit the boy.'% Common argument is subject in main and rel clause, no Nom case-marking
...
`I saw the coyote that killed the chicken.' %\citet[213]{Kendall:1976}
...
%Check glossing
\begin{exe}\ex\label{CocDep} {Cocopa\il{Cocopa}} \citetext{Yuman; California; \citealt[191]{Crawford:1966}, \citealp[325]{Langdon.Munro:1979}}\nopagebreak[4]
\begin{xlist} 
...
`He arrived there at the king's house.' %\citet[191]{Crawford:1966}\end{exe}
...
%\pagebreak
\begin{exe}\ex\label{DieDep} {Diegue\~no\il{Diegue\~no (Mesa Grande)} (Mesa Grande)} \citep[Yuman; California; ][135]{Gorbet:1976}\nopagebreak[4]
...
`the bite wasn't bad at all' (lit: `where the dog bit me, it wasn't bad at all') \end{exe}\is{clause-type!adverbial clause|)}
...
\begin{exe}\ex\label{MojPass} {Mojave\il{Mojave}} \citep[241, 220]{Munro:1976}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{YavPass} {Yavapai\il{Yavapai}} \citep[127]{Kendall:1976}\nopagebreak[4]
\begin{xlist}
...
\pagebreak
\begin{exe}\ex\label{HavPass} {Havasupai\il{Havasupai}} \citep[Yuman; Arizona; ][60, 61]{Kozlowski:1972}\nopagebreak[4]
\begin{xlist}
...
`The water is lying all over the ground (over there). %\citet[61]{Kozlowski:1972}\end{exe}  %maybe ommit this example since the translation ios n ot clear
\end{xlist}
\end{exe}

\begin{exe}\ex\label{WapPass1} {Wappo\il{Wappo}}  \citep[79, 40]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{WapPass2} {Wappo\il{Wappo}}  \citep[79, 46]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist}
...
\begin{exe} \ex\label{NiaRelS} {Nias\il{Nias}} \citetext{Sundic; Indonesia; \citealt[414, 559]{Brown:2001}}\nopagebreak[4]
\begin{xlist}
...
`His uncle died yesterday.' %559
\end{xlist} 
\end{exe}

\begin{exe} \ex\label{NiaRelP} {Nias\il{Nias}} \citetext{\citealt[414]{Brown:2001}}\nopagebreak[4]
\begin{xlist} 
\ex \gll Andrehe'e {nasu}  {\rm[}si=usu \textbf{ya'o}{\rm]}\\
\dist{} dog.\mut{} \relativ{}=bite 1\sg{}\\
`That's the dog that bit me.'  %414
...
\pagebreak
\begin{exe} \ex\label{NiaRelP2} {Nias\il{Nias}} \citetext{\citealt[415]{Brown:2001}}\nopagebreak[4]
\begin{xlist}
...
`That is the tree that he took those papaya from.' %415
...
The A argument of a relative clause is realized as a noun in the Mutated form (\ref{NiaRelA}), while in main clauses it would be Unmutated.
...
`I used the coconut which she grated.' %420
...
{Nias\il{Nias}} \citep[422]{Brown:2001}\nopagebreak[4]
\begin{xlist} 
...
\begin{exe}\ex\label{AijDep} {Aji\"e\il{Aji\"e}} \citetext{Oceanic; New Caledonia; \citealt[113]{Lichtenberk:1978} after \citealt[330]{Fontinelle:1976} and \citealt[189, 190]{Fontinelle:1961}}\nopagebreak[4]
\begin{xlist}
...
`He calls for rain so that the ground may be wet.' %\citet[113]{Lichtenberk:1978} \end{exe}
...
`I am not going to touch it because my hand might smell (and) because the rat might eat my braids.'%\citet[113]{Lichtenberk:1978} after \citet[189f.]{Fontinelle:1961} \end{exe}
\end{xlist}
\end{exe}\is{clause-type!adverbial clause|)}
...
Adverbial clauses\is{clause-type!adverbial clause|(}, on the other hand, use either the Nominative\is{case!individual forms!nominative}  or Genitive\is{case!individual forms!genitive} case to mark their subjects (\ref{SavAdv}). 

\begin{exe}\ex\label{SavRel} {Savosavo\il{Savosavo}} \citep[Solomons East Papuan; Solomon Islands; ][257, 258]{Wegener:2008}\nopagebreak[4]
\begin{xlist}
\ex\gll  {\rm[}lo fomu=gha \textbf{ze} pale-tu{\rm]} lo mavutu\\ 
\deter{}.\pl{} form=\pl{} 3.\pl{}.\gen{} stay-\relativ{} \deter{}.\sg{} place \\
`The place where the forms are.'% \citet[257]{Wegener:2008}
...
`the man whose daughter went to Honiara' %\citet[258]{Wegener:2008}
\end{xlist}
\end{exe}\is{clause-type!relative clause|)}

\pagebreak
\begin{exe}\ex\label{SavAdv} {Savosavo\il{Savosavo}} \citep[275, 272]{Wegener:2008}\nopagebreak[4]
\begin{xlist}
...
`As the rooster crowed, they already scraped (coconuts), the men.' %\citet[275]{Wegener:2008}
...
`One night as she was still awake sitting there, the giants snored.' %\citet[275f.]{Wegener:2008}
...
\conj{}=3\sg{}.\mas{}.\nom{} 1\sg{}.\gen{} father=\nom{} ask then=3\pl{}.\nom{} say(-\fin{})\\
`Then my father asked and then they said \dots' %Temporal clauses: \citet[272]{Wegener:2008}
\end{xlist}
\end{exe}\is{clause-type!adverbial clause|)}
...
%\pagebreak
\medskip
\begin{exe}\ex\label{NiaPass}  {Nias\il{Nias}}  \citep[573]{Brown:2001}\nopagebreak[4]
%\begin{xlist} 
...
\begin{exe}\ex\label{NiaTR} {Nias\il{Nias}} \citep[556, 555]{Brown:2001}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{SavPass} {Savosavo\il{Savosavo}} \citep[171]{Wegener:2008}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{ParMN} {P\"ari\il{P\"ari}} \citep[Nilotic; Sudan; ][319, 318, 292]{Andersen:1988}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{TenRel} {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][259, 255]{Randal:1998}\nopagebreak[4] 
\begin{xlist}
...
\begin{exe}\ex\label{NanRel} {Nandi\il{Nandi}} \citep[Nilotic; Kenya; ][134, 133]{Creider:1989}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MurDep} {Murle\il{Murle}\il{Murle\il{Murle}}} \citep[Surmic; Sudan; ][112, 113, 114]{Arensen:1982}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{kEEti} \textipa{naana} \textipa{kiziwan}  {\rm[}\textipa{o} \textipa{or} \textbf{\textipa{niina}}{\rm]}\\
skin.1\sg{} 1\sg{}.\nom{} buffalo.\acc{} which shoot.\pst{} 2\sg{}.\nom{}\\
`I am skinning the buffalo which you shot.'
...
\begin{exe}\ex\label{TurRel} {Turkana\il{Turkana}} \citep[Nilotic; Kenya; ][309, 314]{Dimmendaal:1982}\nopagebreak
\begin{xlist}
...
`In the forest where there are baboons and elephants.'  %[314]
\end{xlist}
\end{exe}\is{clause-type!relative clause|)}
...
\begin{exe}\ex\label{TurDep} {Turkana\il{Turkana}} \citep[374]{Dimmendaal:1982}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MurPass} {Murle\il{Murle}\il{Murle\il{Murle}}} \citep[140, 137]{Arensen:1982}\nopagebreak[4]
\begin{xlist}
\ex\gll \textipa{ajuk-E} \textipa{EEt\textbf{-i}}\\
trow-\pass{} man-\nom{}\\
`The man is thrown.' %\citet[140]{Arensen:1982} 

\ex\gll\textipa{ajuk} \textipa{EEt\textbf{-i}} \textipa{dila}\\
trow man-\nom{} spear.\acc{}\\
`The man throws a spear.' %\citet[137]{Arensen:1982}
\end{xlist}
\end{exe}

\begin{exe}\ex {Tennet\il{Tennet}} \citep[245]{Randal:1998}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{NanPass} {Nandi\il{Nandi}} \citep[125, 126]{Creider:1989}\nopagebreak[4]
\begin{xlist}\ex\gll\textipa{k\'a:-ko-y\`a:t-\'ak} \textbf{\textipa{ka:ri:k}}\\
\pst{}-3-open-\stat{}/\pass{} houses.\nom{}\\
`The houses have been opened.'% \citet[125]{Creider:1989}
...
\begin{exe}\ex\label{MaaPass} {Maa\il{Maa}} \citep[ex.11, ex.13, ex.16, ex.15]{Payne:2007}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{N-\'e-duN-o} \textipa{En-\textbf{\'am\`Uk\`E}}\\
\con{}-3-cut-\Mid{}.\Non\_\pfv{} \fem{}.\sg{}-sandal.\nom{}\\
`The shoe was cut.'
...
\begin{exe}\ex\label{BorRel} {Oromo (Boraana\il{Oromo (Boraana)})} \citetext{Eastern Cushitic; Ethiopia; \citealt[104]{Stroomer:1995}, \citealt[125]{OromoTexts}}\nopagebreak[4]
\begin{xlist}
...
`The people who killed Diido were the Janjamtu.' %\citet[125]{OromoTexts}
\end{xlist}
\end{exe}

\begin{exe} \ex\label{HarRel}  {Oromo (Harar\il{Oromo (Harar)})} \citep[Eastern Cushitic; Ethiopia; ][131, 143]{Owens:1985}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{ArbDep} {Arbore\il{Arbore}} \citep[Eastern Cushitic; Ethiopia; ][318, 321]{Hayward:1984}\nopagebreak[4]
\begin{xlist}
...
`That woman, I know that she died.' %[321]
\end{xlist}
\end{exe}	
...
\begin{exe}\ex\label{KabDep} {K'abeena\il{K'abeena}} \citep[Eastern Cushitic; Ethiopia; ][287]{Crass:2005}\nopagebreak[4]
\begin{xlist}
...
\begin{sloppypar} `When/After/Because a hyena (had) shrieked, I was shocked and stood up.' %\end{sloppypar}
\\
%\begin{sloppypar} 
...
\pagebreak
\begin{exe}\ex\label{GamDep} {Gamo\il{Gamo}} \citep[Omotic; Ethiopia; ][400, 361]{Hompo:1990}\nopagebreak[4]
\begin{xlist}
\ex\gll [nun\textbf{-i} be\textglotstop-i-d-a] misiri-y-aa pi\`sa o\`s-a-us\\
...
For Gamo\il{Gamo}, no information on this topic is provided in the grammar.  

\begin{exe}\ex\label{KabPass} {K'abeena\il{K'abeena}} \citep[275]{Crass:2005}\nopagebreak[4]
\begin{xlist}
...
\enlargethispage{2\baselineskip}
%\pagebreak
\begin{exe}\ex\label{KabPass2} {K'abeena\il{K'abeena}} \citep[275]{Crass:2005}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{GamPass} {Gamo\il{Gamo}} \citep[378, 394]{Hompo:1990}\nopagebreak[4] 
\begin{xlist}
...
`The king was killed by merchants.' %\citet[394]{Hompo:1990}
...
\begin{exe}\ex\label{HarPass} {Oromo (Harar\il{Oromo (Harar)})} \citep[172, 173]{Owens:1985}\nopagebreak[4]
\begin{xlist}
...
All examples of the passive in the Boraana\il{Oromo (Boraana)} dialect of Oromo mark their grammatical subject with the focus-marker\is{focus!overt marker} \emph{yaa} (\ref{BorPass}a, b, c).
\footnote{As the following example demonstrates, at least pronouns can be in the Nominative case when marked by the focus-marker in Boraana\il{Oromo (Boraana)} Oromo. 
...
\begin{exe} \ex\label{BorPass}  {Oromo (Boraana\il{Oromo (Boraana)})} \citep[74, 89, 90]{Stroomer:1995}\nopagebreak[4]
...
`They killed the ox' %\citep[90]{Stroomer:1995}
