...
The following made-up tabloid headline would probably be interpreted as a statement about existence rather than location by most speakers of English\il{English}, yet the subject is marked with the definite article (\ref{Yeti}).\enlargethispage{\baselineskip}

\begin{exe}\ex\label{Yeti} \textit{The Yeti exists.} \end{exe} 
...
\begin{exe} \ex\label{NiasExistExamp} {Nias\il{Nias}} \citep[Sundic; Sumatra, Indonesia; ][344, 358]{Brown:2001}\nopagebreak[4]
...
\begin{exe} \ex {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][236, 236]{Randal:1998}\nopagebreak[4]
 \begin{xlist}
...
\begin{xlist}
\ex\gll\textipa{\textbf{NI-dE\`{}}} \textipa{omwOn\`{}}\\
...
\begin{exe}\ex\label{TurExLoc} {Turkana\il{Turkana}} \citep[82]{Dimmendaal:1982}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{\`e-y\`aka-s\`I} \textipa{\textbf{Na-\`at\`uk}}\\
3-be-\pl{} \NC{}-cows.\nom{}\\
\glt `There are cows (or the cows are there).'

\ex\gll\textipa{\`e-y\`e-i\`{}} \textipa{\textbf{a-p\`EsE}} \textipa{\textbf{a-p\`ey}}\\
3-be-\asp{} \NC{}-girl.\nom{} \NC{}-one.\nom{}\\
...
\pagebreak
\begin{exe}
 \ex\label{TurLocZero} {Turkana\il{Turkana}} \citep[82]{Dimmendaal:1982}\nopagebreak[4]
\begin{xlist}
\ex\gll\textipa{\`e-y\`aka-s\`I} \textipa{a-yON\`{}} \textipa{\textbf{Na-\`at\`uk}}\\
3-be-\pl{} \NC{}-me \NC{}-cows.\nom{}\\
\glt `I have cows.'
\ex\gll\textipa{\textbf{Na-atuk\`{}}} \textipa{\textbf{Nugu\`{}}} \textipa{Na-kaN\`{}}\\
...
\begin{exe}
 \ex\label{MaaExLoc} {Maa\il{Maa}} \citep[Nilotic; Kenya; ][ex.19a, ex.17, ex.20a] {Payne:2007}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MaaExistNoPas} {Maa\il{Maa}} \citep{Payne:2007}\nopagebreak[4]
\begin{xlist}
...
\ex\gll\textipa{\mas{}-E-\'Et\`a} \textbf{\textipa{Ol-m\'Urr\'an\`I}} \textipa{l\'E-m-\'e-ny\'Orr} \textipa{te=n-e-i-pus-\'I\'ek-\`I} \textipa{Enk-\'a\'In\'a}\\ 
...
\begin{exe}\ex {Tennet\il{Tennet}} \citep[Surmic; Sudan; ][223]{Randal:1998}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex {Tennet\il{Tennet}} \citep[236]{Randal:1998}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}
\ex\label{HarLoc}  {Oromo (Harar\il{Oromo (Harar)})}  \citep[Eastern Cushitic; Ethiopia; ][101, 109]{Owens:1985}\nopagebreak[4] 
\begin{xlist}
...
\pagebreak
\begin{exe}\ex\label{KabExist} {K'abeena\il{K'abeena}} \citep [Eastern Cushitic; Ethiopia; ][98, 115, 98]{Crass:2005}\nopagebreak[4]
\begin{xlist}
...
\begin{exe} 
\ex\label{ArboreExistF} {Arbore\il{Arbore}}  \citep[Eastern Cushitic; Ethiopia; ][132]{Hayward:1984}\nopagebreak[4]
...
\begin{exe}\ex\label{BorLoc} {Oromo (Boraana\il{Oromo (Boraana)})} \citep[Eastern Cushitic; Kenya; ][54]{Owens:1982}\nopagebreak[4]
...
\pagebreak 
\begin{exe}\ex\label{GamLoc} {Gamo\il{Gamo}} \citep[Omotic; Ethiopia; ][384]{Hompo:1990}\nopagebreak[4]
...
\begin{exe}\ex\label{WolLoc} {Wolaytta\il{Wolaytta}} \citep[Omotic; Ethiopia; ][587, ex: 332]{Lamberti:1997}\nopagebreak[4]
...
\begin{exe}\ex\label{ZayLoc} {Zayse\il{Zayse}}  \citep[Omotic; Ethiopia; ][261]{Hayward:1990}\nopagebreak
...
\begin{exe}\ex\label{MojExLoc} {Mojave\il{Mojave}} \citep[Yuman; Arizona; ][21, 212, 70]{Munro:1976}\nopagebreak[4]
 \begin{xlist}
...
\begin{exe}\ex\label{MojZeroExist} {Mojave\il{Mojave}} \citep[70]{Munro:1976}\nopagebreak[4]
...
\begin{exe}\ex\label{JamExist} {Jamul\il{Jamul Tiipay} Tiipay} \citetext{Yuman; Mexico; \citealt[231]{Miller:2001}, \citealt[148]{Miller:1990}}\nopagebreak[4]
 \begin{xlist}
...
\begin{exe}\ex\label{DieExLoc} {Diegue\~no\il{Diegue\~no (Mesa Grande)} (Mesa Grande)} \citetext{Yuman; California; \citealt[27]{Gorbet:1976}, \citealt[176]{Langdon:1970}}\nopagebreak[4] 
\begin{xlist} 
...
\begin{exe}\ex {Yavapai\il{Yavapai}} \citep[Yuman; Arizona; ][28, 98]{Kendall:1976}\nopagebreak[4]
\begin{xlist} 
...
\begin{exe}\ex\label{HavEx} {Havasupai\il{Havasupai}} \citep[Yuman; Arizona; ][61]{Kozlowski:1972}\nopagebreak
...
\begin{exe} \ex\label{WapExist}  {Wappo\il{Wappo}} \citep[Wappo-Yukian; California; ][105]{Thompsonetal:2006}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{MaiExist}  {Maidu\il{Maidu}} \citetext{Maiduan; California; \citealt[10]{Maidu:1912}}\nopagebreak[4]
...
\begin{exe}\ex\label{MaiLoc} {Maidu\il{Maidu}} \citetext{\citealt[58]{Shipley:1964}}\nopagebreak[4]
...
\begin{exe} \ex\label{NiaPosExist} {Nias\il{Nias}} \citep[Sundic; Sumatra, Indonesia; ][344, 570]{Brown:2001}\nopagebreak[4]
\begin{xlist} \ex \gll ga so \textbf{g\"ocoa}\\
here exist cockroach.\mut{}\\
\glt `There's a cockroach here.'
...
\begin{exe} \ex\label{NiaNegExist} {Nias\il{Nias}} \citep[358, 575]{Brown:2001}\nopagebreak[4]
...
\begin{exe}\ex {Aji\"e\il{Aji\"e}} \citep[Oceanic; New Caledonia; ][102]{Lichtenberk:1978}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex {Aji\"e\il{Aji\"e}} \citep[110]{Lichtenberk:1978}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{AijLoc2} {Aji\"e\il{Aji\"e}} \citep[110]{Lichtenberk:1978}\nopagebreak[4]
\begin{xlist}
...
\begin{exe}\ex\label{SavExist} {Savosavo\il{Savosavo}} \citep[Solomons East Papuan; Solomon Islands; ][209, 122]{Wegener:2008}\nopagebreak[4]
\begin{xlist} 
...
\begin{exe}
\ex\label{SavLoc} {Savosavo\il{Savosavo}} \citep[92, 208, 209]{Wegener:2008}\nopagebreak[4]
\begin{xlist}
%\end{exe}
