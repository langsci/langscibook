...
\textsc{Marked"=S} languages are more traditionally known by the name \textsc{marked"=nominative} languages\is{alignment!marked-nominative}. 
...
\begin{figure}[h]\begin{center}\fbox{
...
I will discuss this the notion in more detail in Section~\ref{domains} and Chapter~{method}.} 
...
In most cases the difference is marked by initial consonant mutation\is{case-marking!via nominal mutation}, see Section \ref{morphophon} for a brief discussion of the morphophonemics of nominal mutation in Nias\il{Nias}.}
...
This is the case for the Yuman languages Cocopa\il{Cocopa}\il{Ccopa} \citep[104]{Crawford:1966}, Diegue\~no\il{Diegue\~no (Mesa Grande)} \citep[151]{Langdon:1970}, Mojave\il{Mojave} \citep[18]{Munro:1976}, Yavapai\il{Yavapai} \citep[68]{Kendall:1976} and Hualapai \citep[38]{Watahomigie:2001}. 
...
To\is{case!individual forms!absolute|(} account for the special status of the form used for the P relation, this form is not referred to as `accusative\is{case!individual forms!accusative}' but as the `absolute' case -- e.g. in Turkana\il{Turkana}\il{Turkana\il{Turkana}} \citep{Dimmendaal:1982} or Datooga\il{Datooga} \citep{Kiessling:2007}. 
...
\begin{quote} 
There is a more slender semantic link between O  and S, so that the fourth logical possibility---`marked O case' being extended to also cover S---appears not to occur.\footnote{Dixon's `O' corresponds to `P' in the terminology used here.} (ibid.)  \end{quote}\is{alignment!marked-absolutive|)}
...
In this study I will test both versions of the functional markedness hypothesis -- the weak one and the strong one.\is{marked-S languages!functional definition!strong versus weak hypothesis|)} 
...
On the other hand, if a language makes use of a copula in nominal predications, this copula might not behave like other verbs in terms of agreement and other properties. \citet{Pustet:2003} notes the tendency of copulas not to behave like verbs in terms of morphosyntax.\is{alignment!through verbal indexing|)}\is{verbal indexing|)} 
