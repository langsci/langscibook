...
Figures and tables should come with a caption that is set below them. The caption should be in
...
new chapter. There has to be one counter for figures and another one for tables:
...
\begin{table}[htbp]
\caption{An example of a table taken from \citew[214]{Croft2003a}}
\begin{tabularx}{\linewidth}{llX}\hline\hline
