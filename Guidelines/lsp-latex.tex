...
If you want to add a footnote that provides the source of an example as in (\mex{1}), you can do
this as follows:
\ea
...
provided you load the \texttt{xeCJK} package. (\mex{1}) provides an example and the following
