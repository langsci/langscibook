...
books, articles, or technical reports. \lsp has a special class that is called \emph{langsci} and is
...
\begin{tabularx}{\linewidth}{ll}\hline\hline
...
number is passed with the \emph{number} option to the langsci class.
...
There are three options for output: \emph{long}, \emph{short}, and \emph{inprep}. If you pass
\emph{long} to the langsci class, all pages are printed. This includes front and backpane of the
cover and also its spine. If the option \emph{short} is used, the cover pages are omitted. This
document version is much more printer friendly since the colored pages are not included.

The option \emph{inprep} suppresses everything that refers to \lsp. This gives authors the
...
\emph{draftmode}. This prints a large watermark onto the first page and adds a footer to ever page
