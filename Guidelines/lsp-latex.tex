...
\newcommand{\logo}{\raisebox{-1.25em}{\resizebox{2cm}{!}{\color{\lsSeriesColor}\includegraphics{LSP/lsp-logos/langsci_logo_nocolor.pdf}}}}
\cfoot[\raggedright\rm\scriptsize \logo\begin{tabular}{l@{}}In Joan Bresnan(ed.), \emph{The mental representation of grammatical relations}\\  Empirically Oriented Theoretical Morphology and Syntax, 282–390.\\Berlin: Language Science Press. http://langsci-press.org/catalog/book/18\end{tabular}]{} 
